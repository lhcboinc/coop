...
class PagesController extends Controller
{
    ...
    public function index()
    {
        ...
        $pages = Page::with(['author', 'editor', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.pages.create', compact('authors', 'editors'));
    }
    ...
    public function edit(Page $page)
    {
        ...
        $page->load('author', 'editor');

        return view('admin.pages.edit', compact('authors', 'editors', 'page'));
    }
