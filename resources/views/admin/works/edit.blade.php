    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.works.update", [$work->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $work->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $work->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_lat') ? 'is-invalid' : '' }}" type="text" name="gps_lat" id="gps_lat" value="{{ old('gps_lat', $work->gps_lat) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_long') ? 'is-invalid' : '' }}" type="text" name="gps_long" id="gps_long" value="{{ old('gps_long', $work->gps_long) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gps_approx') ? 'is-invalid' : '' }}" name="gps_approx" id="gps_approx" required>
                    ...
                    @foreach(App\Models\Work::GPS_APPROX_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gps_approx', $work->gps_approx) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment_type') ? 'is-invalid' : '' }}" name="payment_type" id="payment_type" required>
                    ...
                    @foreach(App\Models\Work::PAYMENT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment_type', $work->payment_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_rate') ? 'is-invalid' : '' }}" type="number" name="payment_rate" id="payment_rate" value="{{ old('payment_rate', $work->payment_rate) }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('transportation') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="transportation" id="transportation" value="1" {{ $work->transportation || old('transportation', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('catering') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="catering" id="catering" value="1" {{ $work->catering || old('catering', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $work->country) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('county') ? 'is-invalid' : '' }}" type="text" name="county" id="county" value="{{ old('county', $work->county) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $work->city) }}" required>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $work->address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip') ? 'is-invalid' : '' }}" type="text" name="zip" id="zip" value="{{ old('zip', $work->zip) }}">
                @if($errors->has('zip'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zip') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client_id" id="client_id" required>
                    @foreach($clients as $id => $entry)
                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') : $work->client->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('client_ip') ? 'is-invalid' : '' }}" type="text" name="client_ip" id="client_ip" value="{{ old('client_ip', $work->client_ip) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    @foreach(App\Models\Work::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $work->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('impressions') ? 'is-invalid' : '' }}" type="number" name="impressions" id="impressions" value="{{ old('impressions', $work->impressions) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('views') ? 'is-invalid' : '' }}" type="number" name="views" id="views" value="{{ old('views', $work->views) }}" step="1">
                @if($errors->has('views'))
                    <div class="invalid-feedback">
                        {{ $errors->first('views') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('endorsed') ? 'is-invalid' : '' }}" name="endorsed" id="endorsed">
                    ...
                    @foreach(App\Models\Work::ENDORSED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('endorsed', $work->endorsed) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('reported') ? 'is-invalid' : '' }}" name="reported" id="reported">
                    ...
                    @foreach(App\Models\Work::REPORTED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('reported', $work->reported) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
