    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('signal') ? 'is-invalid' : '' }}" type="text" name="signal" id="signal" value="{{ old('signal', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('viber') ? 'is-invalid' : '' }}" type="text" name="viber" id="viber" value="{{ old('viber', '') }}">
                @if($errors->has('viber'))
                    <div class="invalid-feedback">
                        {{ $errors->first('viber') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('ready_to_go') ? 'is-invalid' : '' }}" type="text" name="ready_to_go" id="ready_to_go" value="{{ old('ready_to_go') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('latest_activity') ? 'is-invalid' : '' }}" type="text" name="latest_activity" id="latest_activity" value="{{ old('latest_activity') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating_as_worker') ? 'is-invalid' : '' }}" type="number" name="rating_as_worker" id="rating_as_worker" value="{{ old('rating_as_worker', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating_as_client') ? 'is-invalid' : '' }}" type="number" name="rating_as_client" id="rating_as_client" value="{{ old('rating_as_client', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_lat') ? 'is-invalid' : '' }}" type="text" name="gps_lat" id="gps_lat" value="{{ old('gps_lat', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gps_long') ? 'is-invalid' : '' }}" type="text" name="gps_long" id="gps_long" value="{{ old('gps_long', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('notify_email') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="notify_email" id="notify_email" value="1" {{ old('notify_email', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('notify_push') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="notify_push" id="notify_push" value="1" {{ old('notify_push', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('notify_sms') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="notify_sms" id="notify_sms" value="1" {{ old('notify_sms', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('confirmed_at') ? 'is-invalid' : '' }}" type="text" name="confirmed_at" id="confirmed_at" value="{{ old('confirmed_at') }}">
