...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.verification.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.verifications.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('doc_country') ? 'is-invalid' : '' }}" type="text" name="doc_country" id="doc_country" value="{{ old('doc_country', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lastdigits') ? 'is-invalid' : '' }}" type="text" name="lastdigits" id="lastdigits" value="{{ old('lastdigits', '') }}">
