    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.feedback.update", [$feedback->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('work') ? 'is-invalid' : '' }}" name="work_id" id="work_id" required>
                    @foreach($works as $id => $entry)
                        <option value="{{ $id }}" {{ (old('work_id') ? old('work_id') : $feedback->work->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('work'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client_id" id="client_id" required>
                    @foreach($clients as $id => $entry)
                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') : $feedback->client->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('client_rating') ? 'is-invalid' : '' }}" type="number" name="client_rating" id="client_rating" value="{{ old('client_rating', $feedback->client_rating) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('client_feedback') ? 'is-invalid' : '' }}" type="text" name="client_feedback" id="client_feedback" value="{{ old('client_feedback', $feedback->client_feedback) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('client_wrote_at') ? 'is-invalid' : '' }}" type="text" name="client_wrote_at" id="client_wrote_at" value="{{ old('client_wrote_at', $feedback->client_wrote_at) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hide_client_feedback') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hide_client_feedback" id="hide_client_feedback" value="1" {{ $feedback->hide_client_feedback || old('hide_client_feedback', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('worker') ? 'is-invalid' : '' }}" name="worker_id" id="worker_id">
                    @foreach($workers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('worker_id') ? old('worker_id') : $feedback->worker->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('worker_rating') ? 'is-invalid' : '' }}" type="number" name="worker_rating" id="worker_rating" value="{{ old('worker_rating', $feedback->worker_rating) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('worker_feedback') ? 'is-invalid' : '' }}" type="text" name="worker_feedback" id="worker_feedback" value="{{ old('worker_feedback', $feedback->worker_feedback) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('worker_wrote_at') ? 'is-invalid' : '' }}" type="text" name="worker_wrote_at" id="worker_wrote_at" value="{{ old('worker_wrote_at', $feedback->worker_wrote_at) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hide_worker_feedback') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hide_worker_feedback" id="hide_worker_feedback" value="1" {{ $feedback->hide_worker_feedback || old('hide_worker_feedback', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                    ...
                    @foreach(App\Models\Feedback::STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status', $feedback->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
